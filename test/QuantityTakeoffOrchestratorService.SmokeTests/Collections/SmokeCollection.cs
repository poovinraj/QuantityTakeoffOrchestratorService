...
namespace QuantityTakeoffOrchestratorService.SmokeTests.Collections;

/// <summary>
///     Decorate tests classes with the [Collection("IntegrationCollection")] and you can inject
///     <see cref="SmokeFixture" /> into the constructor if you want access to the pipeline and database.
/// </summary>
/// <remarks>
...
/// </remarks>
[CollectionDefinition("SmokeCollection")]
public class SmokeCollection : ICollectionFixture<SmokeFixture>
{
}
