...
6. Use the create_pull_request tool to open a Pull Request. The PR body **must** include the following metadata block exactly as shown (substituting the actual `workflow-run-id` value from the github context):
